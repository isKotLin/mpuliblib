package com.zhongjia.smartorder.util;

import android.text.TextUtils;

import com.zhongjia.smartorder.MyApplication;
...
import static com.zhongjia.smartorder.util.Constant.NO_NET;
import static com.zhongjia.smartorder.util.Constant.SERVER_ERROR;
...
public class Okhttp {
    ...
    public static void setHeader(OkHttpRequestBuilder builder) {
        String appversion = PublicUtls.getVerName(MyApplication.getInstance());
    ...
    public static void setTokenId(String tokentid) {
        MyApplication.sp.edit().putString("tokenid", tokentid).commit();
        tokenId = tokentid;
    }
